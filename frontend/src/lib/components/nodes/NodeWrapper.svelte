...
>
	<!-- Selection Toolbar -->
	{#if isSelected && !isResizing && !isDragging}
		<foreignObject
			x={0}
			y={-50}
		...
		>
			<div
				class="pointer-events-auto mx-auto flex w-fit origin-bottom scale-90 items-center justify-center gap-2 rounded-full border border-slate-700 bg-slate-800 p-1.5 shadow-xl transition-transform"
			>
				<!-- Colors -->
				<button
					class="h-4 w-4 rounded-full bg-slate-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('slate');
					}}
				...
				></button>
				<button
					class="h-4 w-4 rounded-full bg-red-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('red');
					}}
				...
				></button>
				<button
					class="h-4 w-4 rounded-full bg-green-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('green');
					}}
				...
				></button>
				<button
					class="h-4 w-4 rounded-full bg-amber-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('amber');
					}}
				...
				></button>
				<button
					class="h-4 w-4 rounded-full bg-indigo-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('indigo');
					}}
				...
				></button>
				<button
					class="h-4 w-4 rounded-full bg-cyan-500 ring-1 ring-white/10 transition-transform hover:scale-110"
					onmousedown={(e) => {
						e.stopPropagation();
						updateColor('cyan');
					}}
				...
				<!-- Actions -->
				<button
					class="p-0.5 text-slate-400 transition-colors hover:text-white"
					onmousedown={duplicateNode}
				...
				<button
					class="p-0.5 text-red-400 transition-colors hover:text-red-200"
